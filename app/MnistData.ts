...
async function fetchOnceAndSaveToDiskWithBuffer(filename : any) {
...
async function loadImages(filename : any) {
...
async function loadLabels(filename : any) {
    const buffer : any = await fetchOnceAndSaveToDiskWithBuffer(filename);
